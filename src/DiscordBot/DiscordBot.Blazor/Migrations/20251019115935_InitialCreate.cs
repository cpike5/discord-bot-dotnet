        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiscordDiscriminator = table.Column<string>(type: "TEXT", maxLength: 4, nullable: true),
                    DiscordAvatarHash = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    DiscordLinkedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UsedByApplicationUserId = table.Column<string>(type: "TEXT", maxLength: 450, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_InviteCodes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InviteCodes_AspNetUsers_UsedByApplicationUserId",
                        column: x => x.UsedByApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_DiscordUsername",
                table: "AspNetUsers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InviteCodes_DiscordUserId",
                table: "InviteCodes",
                column: "DiscordUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InviteCodes_UsedByApplicationUserId",
                table: "InviteCodes",
                column: "UsedByApplicationUserId");
        }
